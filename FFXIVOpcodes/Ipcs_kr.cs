namespace FFXIVOpcodes.KR
{
    ...
    */
    enum ServerZoneIpcType : ushort
    {
        ...
        BattleTalk2 = 0x0087, // 7.0
        BattleTalk4 = 0x01BD, // 7.0
        BattleTalk8 = 0x0290, // 7.0
        CEDirector = 0x0379, // 7.0
        CFNotify = 0x02ED, // 7.0
        CFPreferredRole = 0x03C0, // 7.0
        ContainerInfo = 0x01A8, // 7.0
        Countdown = 0x02A5, // 7.0
        CountdownCancel = 0x0385, // 7.0
        ...
        ExamineSearchComment = 0x0313, // 7.0
        ...
        PlayerUpdateLook = 0x023F, // 7.0
        Playtime = 0x010E, // 7.0
        PrepareZoning = 0x01CB, // 7.0
        RetainerInformation = 0x00C6, // 7.0
        RSFData = 0x01A9, // 7.0
        RSVData = 0x010D, // 7.0
        ServerNotice = 0x0195, // 7.0
        ServerNoticeShort = 0x01A5, // 7.0
        SetOnlineStatus = 0x036C, // 7.0
        SocialList = 0x0232, // 7.0
        SocialMessage = 0x0152, // 7.0
        SocialMessage2 = 0x01E3, // 7.0
        SocialRequestResponse = 0x02F2, // 7.0
